...
import { IAdminHomeController as ApiIAdminHomeController } from '../../../api/controllers/admin/contracts'
import { AdminHomeController as ApiAdminHomeController } from '../../../api/controllers/admin/implementations'
import { IUsersController as ApiIUsersController } from '../../../api/controllers/content/contracts'
import { UsersController as ApiUsersController } from '../../../api/controllers/content/implementations'
...
container.bind<ApiIAdminHomeController>(TYPES.ApiIAdminHomeController).to(ApiAdminHomeController)
